module com.example.teamtraininghub {
    ...
    opens engineering.bean to com.google.gson, javafx.base;
    exports viste.first.basi to javafx.graphics;
    opens viste.first.basi to javafx.fxml; // Aggiungi questa riga
